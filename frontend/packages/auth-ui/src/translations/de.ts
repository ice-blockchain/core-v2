...
export const authDE: Record<keyof typeof authEN, string> = {
  ...
  tfaVerificationTitle: '2FA-Verifizierung',
  tfaVerificationSubtitle: 'Bitte geben Sie unten Ihren Bestätigungscode ein',
  selectOptionLabel: 'Option {{number}} auswählen',
  authenticatorCodeOption: 'Authenticator-Code',
  emailCodeOption: 'E-Mail-Code',
  smsCodeOption: 'SMS-Code',
  tfaSendButton: 'Senden',
  tfaRetryButton: 'Erneut senden',
