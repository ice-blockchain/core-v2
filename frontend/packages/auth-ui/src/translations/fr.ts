...
export const authFR: Record<keyof typeof authEN, string> = {
  ...
  errorRestrictedRegion: 'Ce service n\'est pas disponible dans votre région.',
  tfaVerificationTitle: 'Vérification 2FA',
  tfaVerificationSubtitle: 'Veuillez entrer votre code de confirmation ci-dessous',
  selectOptionLabel: 'Sélectionner l\'option {{number}}',
  authenticatorCodeOption: 'Code d\'authentification',
  emailCodeOption: 'Code par e-mail',
  smsCodeOption: 'Code SMS',
  tfaSendButton: 'Envoyer',
  tfaRetryButton: 'Renvoyer',
  tfaCountdownLabel: '{{seconds}}s',
  errorTwoFARequired: 'L\'authentification à deux facteurs est requise.',
  errorInvalidTwoFACode: 'Code de vérification invalide. Réessayez.',
  errorTwoFANotConfigured: 'L\'authentification à deux facteurs n\'est pas configurée.',
  errorInvalidNickname: 'Pseudo invalide.',
  errorNicknameAlreadyExists: 'Ce pseudo est déjà pris.',
  errorNicknameReserved: 'Ce pseudo est réservé.',
  errorInvalidRecoveryCredentials: 'Identifiants de récupération invalides.',
  errorInvalidSignature: 'La vérification de la signature a échoué.',
