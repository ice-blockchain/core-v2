export const authEN = {
  ...
  tfaVerificationTitle: '2FA Verification',
  tfaVerificationSubtitle: 'Please enter your confirmation code below',
  selectOptionLabel: 'Select option {{number}}',
  authenticatorCodeOption: 'Authenticator code',
  emailCodeOption: 'Email code',
  smsCodeOption: 'SMS code',
  tfaSendButton: 'Send',
  tfaRetryButton: 'Retry',
