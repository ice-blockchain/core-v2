...
function buildPrimitiveMethods(id: string): Pick<
  IKeyValueStorage,
...
function buildObjectAndUtilMethods(id: string): Pick<
  IKeyValueStorage,
...
export function createKeyValueStorage(
  ...
  return {
    ...buildPrimitiveMethods(options.id),
    ...buildObjectAndUtilMethods(options.id),
  };
}
