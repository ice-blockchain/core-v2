  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={{ marginTop: 16 }}>
        <PrimaryButton label="Continue" onClick={() => identity.validate() && props.onNavigateToVerifyPasskey()} />
      </div>
      <span style={orStyle}>or</span>
      <SecondaryButton label="Register" onClick={props.onNavigateToRegister} leftIcon={<CreateAccountIcon />} />
