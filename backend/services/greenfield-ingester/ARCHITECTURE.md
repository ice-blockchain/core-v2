...
| Lua-script dedup in AddJob | Atomic EXISTS+HSET via Lua script prevents TOCTOU races in multi-instance deployments; remaining queue commands (RPUSH, XADD) run in the pipeline |
